    ...
    <section id="about">
      ...
      <div className="container about__container">
        ...
        <div className="intro__container">
          ...
          <p>
          Passionate and dedicated undergraduate with a strong focus on software and web development, eager to apply and enhance my skills in real-world projects. Proficient in key programming languages including PHP, JavaScript, Python, and C. Eager to contribute to innovative solutions, collaborate effectively in a team environment, and committed to continuous learning to stay at the forefront of software and web development technologies and best practices.
          </p>
          <br></br>
